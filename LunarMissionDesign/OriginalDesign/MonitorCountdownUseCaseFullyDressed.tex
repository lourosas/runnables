...
the time stopped.
\item[4b.]If the Countdown is on hold, then the Flight Controller can
chose to abort the Countdown--Clearing the Countdown and aborting the
Rocket Launch \textit{See Use Case 1: Flight Controller shall Monitor
the Pre-Launch}
\end{itemize}
