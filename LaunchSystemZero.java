...
public class LaunchSystemZero extends LaunchSystem 
implements Runnable{
   ...
   public void addSubscriber(Subscriber subscriber){
      try{
         ...
         this.setPublisher(new LaunchSystemZeroPublisher());
         this.publisher.addSubscriber(subscriber);
      }
   }
   ...
   private void initializeRocket(String file){
      try{
         ...
         this.setRocket(new GenericRocket());
         try{
            this.rocket.initializeComponent(file);
         }
         catch(IOException ioe){
